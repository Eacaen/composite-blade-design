...
#define lamina from fibre and matrix
	f = Fibre(Ef1 = 74000,Ef2 = 74000 , Gf12 = 30800,vf21 = 0.2,density = 2.55)
	m = Matrix(Em = 3300 , Gm = 1222 , vm = 0.35,density = 1.18)

	a = Lamina()
	a.Fibre_Matrix_Lamina(f,m ,fibre_mass = 0.4 ,fibre_volume = 0, \
								Xt = 597.9, Xc = 650,Yt = 37.7, Yc = 130, S = 37.5,\
								max_stain_t=0.0218,max_stain_c=0.0218,angle = 30,thickness = 1)

	b = Lamina()
	b.Fibre_Matrix_Lamina(f,m ,fibre_mass = 0.4 ,fibre_volume = 0.59, \
								Xt = 597.9, Xc = 650,Yt = 37.7, Yc = 130, S = 37.5,\
								max_stain_t=0.0218,max_stain_c=0.0218,angle = 60,thickness = 1)
...
#define lamina directly 
	...
	# aa = Lamina(5.4e4,1.8e4,8.8,v21 = 0.25,Xt = 1.05,Xc = 1.05,\
	# 										Yt = 28,Yc = 140, S = 42,\
	# 										angle = 0,thickness=1)
