...
class Fibre(object):
	"""docstring for Fibre"""
	def __init__(self, Ef1 = 0, Ef2 = 0,Gf12 = 0, vf21 = 0 ,density = 0 ,unit = 1, name = 'Fibre_'):
		...
		self.name = name
	def change_Fibre(self, Ef1, Ef2 ,Gf12 ,vf21 ,unit,density, name = 'Fibre_'):
		self.Ef1  = Ef1 * unit
		self.Ef2  = Ef2 * unit
		self.Gf12 = Gf12 * unit
		self.vf21 = vf21
...
class Matrix(object):
	...
	def __init__(self, Em = 0 , Gm = 0, vm = 0 , density = 0,unit =1,name = 'Matrix_'):
	...
	def change_Matrix(self, Em ,Gm,vm,unit , density,name = 'Matrix_'):
		self.Em = Em * unit 
		self.Gm = Gm * unit
		self.vm = vm 
		self.density  = density
...
class Lamina(object):
	...
	name_counter = 0
	name_list = []
	def __init__(self,E1 = 0, E2 = 0, G12 = 0,v12 = 0,v21 = 0,\
					Xt = 0, Xc = 0,Yt = 0, Yc = 0, S = 0,max_stain_t = 0,max_stain_c=0,\
					angle = 0,thickness = 0,density = 0,name = 'Material_'):
		...
		if self.E1 !=0 and self.E2 != 0 and self.G12 !=0: 
			# if define from the fibre&matrix way, the Elastic Moduli will equal to Zero
			
			self.matrix_S = self.get_S()
			self.matrix_Q = self.get_Q()
			self.matrix_Tstress = self.get_Tstress(angle)
			self.matrix_Tstrain = self.get_Tstrain(angle)
...
#************************************************************************
	def Fibre_Matrix_Lamina(self,fibre,matrix,fibre_mass =0 ,fibre_volume = 0, \
								Xt = 0, Xc = 0,Yt = 0, Yc = 0, S = 0,\
						max_stain_t=0,max_stain_c=0,angle = 0,thickness = 0):
		self.fibre = fibre
		self.matrix = matrix
...
#************************************************************************
		...
		self.density = fm * fibre.density + mm * matrix.density
#************************************************************************
		self.E1 = fibre.Ef1 * fm + matrix.Em * mm
#************************************************************************
#	the E2 from the VDI2014 Part3 p29
#************************************************************************
...
#************************************************************************						
		self.E2  = (fibre.Ef2 * matrix.Em) / (matrix.Em * fm + fibre.Ef2 * mm )		
		self.G12 = fibre.Gf12 * matrix.Gm / (fibre.Gf12 * mm + matrix.Gm * fm)

		self.v21 = fibre.vf21 * fm + matrix.vm * mm
